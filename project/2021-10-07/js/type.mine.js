...
*/
var theme_content = {
    "pure_words_content": "️️💕愿与你相识、相知、相爱、相惜…… ",
    "pure_words_append": ['💕一步相识', '💕二步相知', '💕三步相惜', '💕四步相恋', '💕五步相爱', '💕六步相随，', '💕七步相守', '💕八步不离不弃', '💕九步共白头', '💕十步及尔偕老'],
    "typed_bool": "typed_y",
        ...
        var typed_pure_words = new Typed('#span_pw_typed', {
            ...
            onComplete: function(abc) {
                ...
                $('#no').on('click', function() {
                    ...
                    var words_span = $('<div class="span_typed"></div>');
                    if (words_index >= theme_content['pure_words_append'].length) {
                        //展示委屈表情  
                        $('.cover').fadeIn();
                    ...
                    words_span.html(theme_content['pure_words_append'][words_index]);
                    words_index++;
                    words.append(words_span);
                    $('.div_pure_words').append(words);
                });
